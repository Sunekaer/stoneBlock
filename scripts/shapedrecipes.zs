...
//making Deep Dark recipe harder
recipes.remove( < extrautils2: teleporter: 1 > );
recipes.addShaped( < extrautils2: teleporter: 1 > , [
  [ < extrautils2: compressedcobblestone: 4 > , < extrautils2: compressedcobblestone: 5 > , < extrautils2: compressedcobblestone: 4 > ],
  [ < extrautils2: compressedcobblestone: 5 > , < extrautils2: compressedcobblestone: 6 > , < extrautils2: compressedcobblestone: 5 > ],
  [ < extrautils2: compressedcobblestone: 4 > , < extrautils2: compressedcobblestone: 5 > , < extrautils2: compressedcobblestone: 4 > ]
]);

//making aroma1997sdimension recipe harder
recipes.remove( < aroma1997sdimension: miningmultitool > );
recipes.addShaped( < aroma1997sdimension: miningmultitool > , [
  [ < extrautils2: compressedcobblestone: 4 > , < minecraft: stone_pickaxe > , < extrautils2: compressedcobblestone: 4 > ],
...
//Cobblestone Gen using Oredict and ceramics buckets
...
recipes.addShaped( < tp: cobblegen_block > , [
  ...
  }), < ore: blockGlass > , < ceramics: clay_bucket > .withTag({
    fluids: {
      FluidName: "lava",
      Amount: 1000
    }

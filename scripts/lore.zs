...
//AE2
<appliedenergistics2:material:13>.addTooltip(format.yellow("Can be found in meteorites in Aroma1997´s dimension or crafted"));
<appliedenergistics2:material:14>.addTooltip(format.yellow("Can be found in meteorites in Aroma1997´s dimension or crafted"));
<appliedenergistics2:material:15>.addTooltip(format.yellow("Can be found in meteorites in Aroma1997´s dimension or crafted"));
<appliedenergistics2:material:19>.addTooltip(format.yellow("Can be found in meteorites in Aroma1997´s dimension or crafted"));
...
//What makes water in Wooden Crucible
<exnihilocreatio:block_crucible_wood>.addTooltip(format.yellow("Vanilla minecraft saplings and leaves makes water"));
